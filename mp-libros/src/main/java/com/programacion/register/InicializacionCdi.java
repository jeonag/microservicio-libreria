...
public class InicializacionCdi {
	...
	public void init(@Observes @Initialized(ApplicationScoped.class) Object obj) throws UnknownHostException {
		...
		check.setMethod("GET");
		check.setHttp("http://" + consulHost + ":" + appPort + "/q/health");
...
//		String trafik = String.format("traefik.tracing.attribute.port=%s",appPort);
//		String trafiktag = String.format("traefik.http.services.%s.tracing.default_tags.port=%s",appName,appPort);
